...
public class ReusableMethods {
    ...
    public static void enterTextAndWait(WebElement element, String text, int timeout) {
        element.clear();
        ReusableMethods.hardWait(timeout);
        element.sendKeys(text);
    }
    public static void waitToBeClickableBy(By selector, int timeout) {
        WebDriverWait wait = new WebDriverWait(Driver.getDriver(), Duration.ofSeconds(timeout));
    ...
    public static String getScreenshot() throws IOException {
        ...
        String target = "."+separator+"test-output"+separator+"screenshots"+separator+"screenshot "  + date + ".png";
